...
indexer.onEvent({ contract: "ExecuteSelectorCondition", event: "SelectorAllowed" }, async ({ event, context }) => {
...
indexer.onEvent({ contract: "ExecuteSelectorCondition", event: "SelectorDisallowed" }, async ({ event, context }) => {
